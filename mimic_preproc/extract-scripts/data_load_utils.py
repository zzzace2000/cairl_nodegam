...
def my_readcsv(path, usecols=None):
	'''
	In the original script, they have upper case colnames while my csv
	has lower case columns. So do a conversion...
	'''
	if usecols is not None:
		usecols = [n.lower() for n in usecols]

	df = pd.read_csv(path, usecols=usecols)
	# Make them as upper case to accomodate...
